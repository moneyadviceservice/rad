    ...
    let(:expected_json) do
      {
        ...
        retirement_income_products: firm.retirement_income_products_flag,
        pension_transfer: firm.pension_transfer_flag,
        options_when_paying_for_care: firm.long_term_care_flag,
        equity_release: firm.equity_release_flag,
        inheritance_tax_planning: firm.inheritance_tax_and_estate_planning_flag,
        wills_and_probate: firm.wills_and_probate_flag,
