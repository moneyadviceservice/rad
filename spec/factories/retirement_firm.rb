FactoryBot.define do
  factory :retirement_firm, class: RetirementFirm, aliases: %i[publishable_firm onboarded_firm] do
    ...
    factory :retirement_firm_without_advisers, traits: [:without_advisers]
    factory :retirement_firm_with_offices, traits: [:with_offices]
    factory :retirement_firm_without_offices, traits: [:without_offices]
    factory :retirement_firm_with_advisers_and_offices, traits: %i[with_advisers with_offices]
    factory :retirement_firm_with_principal, traits: [:with_principal]
    factory :retirement_firm_with_no_business_split, traits: [:with_no_business_split]
    factory :retirement_firm_with_remote_advice, traits: [:with_remote_advice]
    factory :retirement_firm_with_subsidiaries, traits: [:with_trading_names]
    factory :retirement_firm_with_trading_names, traits: [:with_trading_names]
