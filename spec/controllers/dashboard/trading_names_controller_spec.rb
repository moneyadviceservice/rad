module Dashboard
  RSpec.describe Dashboard::TradingNamesController, type: :controller do
    ...
    describe 'GET #new' do
      ...
      context 'when passed a lookup_id' do
        ...
        it 'renders the new page' do
          expect(subject).to render_template 'dashboard/trading_names/new'
        end
      end
    end
    ...
    describe 'POST #create' do
      context 'when passed valid details' do
        ...
        it 'renders the edit page' do
          expect(response).to render_template 'dashboard/trading_names/edit'
        end
      end
      ...
      context 'when passed invalid details' do
        ...
        it 'renders the new page' do
          expect(response).to render_template 'dashboard/trading_names/new'
        end
      end
    end
  end
