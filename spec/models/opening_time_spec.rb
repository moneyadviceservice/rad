  ...
  describe "opening time validations" do
    context "weekdays" do
      ...
      it "is valid when all times are correct" do
        opening_time = build(:opening_time, weekday_opening_time: 1.hour.ago, weekday_closing_time: 1.minute.ago)
    ...
    context "when office is open on saturday" do
      ...
      it "is valid when all times are correct" do
        opening_time = build(:opening_time, open_saturday: true, saturday_opening_time: 1.hour.ago, saturday_closing_time: 1.minute.ago)
    ...
    context "when office is open on sunday" do
      ...
      it "is valid when all times are correct" do
        opening_time = build(:opening_time, open_sunday: true, sunday_opening_time: 1.hour.ago, sunday_closing_time: 1.minute.ago)
