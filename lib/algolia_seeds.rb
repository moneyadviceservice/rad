class AlgoliaSeeds # rubocop:disable Metrics/ClassLength
  FIXED_SEEDS = [
    {
  ...
  def firm_base_attributes
    {
      ...
      initial_advice_fee_structures: InitialAdviceFeeStructure.where(id: [1]),
      ongoing_advice_fee_structures: OngoingAdviceFeeStructure.where(id: [2]),
