  ...
  class TravelInsuranceFirm < Base
    class << self
      def create(travel_firms)
        ...
        AlgoliaIndex.indexed_travel_insurance_firms_combined.replace_all_objects(serialized_firms)
    ...
    def update
      ...
      AlgoliaIndex.indexed_travel_insurance_firms_combined.add_object(serialized)
    ...
    def destroy
      AlgoliaIndex.indexed_travel_insurance_firms_combined.delete_object(id)
    end
  end
end
